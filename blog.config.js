...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yui资源', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Yui资源的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yui00600.cf', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yui, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yiguizhong1@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/oovipy/NotionNext', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/Yui00600', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '相ICP备2023028437号', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'Yui资源', // 管理员用户名、一般是自己 e.g 'tangly1024'
